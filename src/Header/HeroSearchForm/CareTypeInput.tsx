  ...
  return (
    <div className={`relative flex ${className}`} ref={containerRef}>
      <div
        ...
        className={`flex z-10 flex-1 relative nc-hero-field-padding flex-shrink-0 items-center space-x-3 cursor-pointer focus:outline-none text-left px-10 py-6 ${showPopover ? "shadow-[0_4px_16px_#11111a0d,_0_8px_32px_#11111a0d] rounded-full" : ""
          }${mobileClassName}`}
      >
        <div className="text-neutral-300 dark:text-neutral-400">
          <img
            className="xs:w-7 xs:h-7 sm:w-8 sm:h-7"
