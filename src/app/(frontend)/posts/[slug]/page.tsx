...
export default async function Post({ params: paramsPromise }: Args) {
  ...
  return (
    <article className="">
      ...
      <div className="nc-post-article relative flex px-0 md:px-10 gap-10">
        ...
        <div className="hidden lg:block w-1/4 h-screen py-10 sticky top-0  overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 gap-10">
          <Link href={`/home`} passHref
            className="text-purple-500 hover:text-purple-700 font-normal rounded mb-10"
          >
            ← &nbsp;  Back
          </Link>
        ...
        <div className="w-full flex flex-col gap-4 py-2 flex-grow overflow-y-auto">
          <div className="">
